...
# ========== 仓位管理配置 ==========
TOTAL_CAPITAL = 69101  # 7/21 东睦清仓(-2785) + 新疆众和清仓(-1504)，仅剩芯片ETF
...
# 历史累计亏损（用于计算回本价）
LOSS_HISTORY = {
    "600114": {"loss": 4879, "name": "东睦股份"},  # 累计：7/8-854+7/15+228 + 7/21减500@25.50(-1468)+清500@25.80(-2785) = -4879
    "518880": {"loss": 273, "name": "黄金ETF"},    # 7/14 止损亏273
    "600888": {"loss": 1504, "name": "新疆众和"},  # 7/21 清仓1200@均价9.043(-1504)
}

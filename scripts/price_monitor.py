...
# ========== 仓位管理配置 ==========
TOTAL_CAPITAL = 68096  # 7/21 清仓：东睦-2785+众和-1504+芯片-1005=总亏-5294，空仓
...
STOCKS = [
    ...
    },
    {
        ...
        # 2026-07-21 清仓：减500@25.50(-1468) + 清500@25.80(-2785)，累计亏-4879
        "code": "1.600114",
        "name": "东睦股份",
        "ts_code": "600114",
        "cost": None,
    ...
    {
        # 2026-07-21 清仓：800@9.04+400@9.05，亏-1504
        "code": "1.600888",
        "name": "新疆众和",
        "ts_code": "600888",
        "cost": None,
...
# 历史累计亏损（用于计算回本价）
LOSS_HISTORY = {
    "600114": {"loss": 4879, "name": "东睦股份"},  # 累计-4879
    "518880": {"loss": 273, "name": "黄金ETF"},    # 7/14 止损-273
    "600888": {"loss": 1504, "name": "新疆众和"},  # 7/21 清仓-1504
    "159599": {"loss": 1005, "name": "芯片ETF"},   # 7/21 清仓2800@2.859(-1005)
}
